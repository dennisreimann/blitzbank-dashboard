...
<style>
:root {
  --color-vibe-90: #0B2545;
  --color-vibe-80: #13315C;
  --color-vibe-60: #134074;
  --color-vibe-30: #8DA9C4;
  --color-vibe-10: #E3F2FD;
...
main {
  ...
  margin: var(--space-m) var(--space-grid-gap) var(--space-xl);
}

main h1 {
  padding: var(--space-grid-gap);
}
